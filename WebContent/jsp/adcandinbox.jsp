...
<%while(rs.next())
{
	String str="Select i.msgid,i.senderid,i.subject,i.date from inbox i,logininfo l where i.receiverid=l.userid and l.usertype='candidate'";
...
<th><%=rs1.getString("senderid") %></th>
<th><a href="/Etalent/jsp/showmessage.jsp?mid=<%=msid%>&pname=inbox"><%=rs1.getString("subject")%>
</a></th>
...
<%} %>
<h1><a href="/Etalent/jsp/adcandmessages.jsp">No,Thanks</a></h1>
<%}} %>
