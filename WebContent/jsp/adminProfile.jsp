...
$(document).ready(function()
		{
	      $("#div").click(function()
	    		  {
	    			$("#divright").load("/Etalent/jsp/viewallUsers.jsp");  
	    		  });
	      $("#div1").click(function()
	    		  {
	    			$("#divright").load("/Etalent/jsp/verifyProf.jsp");  
	    		  });
...
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a id="div" href="#">View Users</a></li>
      <li><a id="div1" href="#">Verify Professionals</a></li>
      <li><a href="/Etalent/jsp/adprofmessages.jsp">Communicate Professionals</a></li>
      <li><a href="/Etalent/jsp/adcandmessages.jsp">Communicate Candidate</a></li>
      <li><a href="/Etalent/jsp/post.jsp">Post</a></li>
    </ul>
     <ul class="nav navbar-nav navbar-right">
     <li><a href="/Etalent/jsp/viewfeedback.jsp"><span class="glyphicon glyphicon-envelope"></span> View Feedback</a></li>
