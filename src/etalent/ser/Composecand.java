...
/**
 * Servlet implementation class Composecand
 */
@WebServlet("/Composecand")
public class Composecand extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String str="Select userid from logininfo where userid=? and usertype='candidate'";
	    		...
	    		String rid=rs1.getString("userid");
	    		 try{
	    				...
	    				if(row<=0 && row1<=0)
	    				{
	    					...
	    					out.println("<h1>Sorry, the receiver is not a candidate, so we can't send this message!!</h1>");
	    				...
	    				else if(row>0 && row1>0)
	    				{
	    					...
	    					response.sendRedirect("/Etalent/jsp/adcandmessages.jsp");
